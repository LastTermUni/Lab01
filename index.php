...
<body >
    <div id="wrapper">
        ...
        <div class="row mb-3">
            <!-- <div class="lbtitle"> -->
            <label for="inputMathage"  class="col-sm-2 col-form-label">Điểm Toán</label>
            <!-- </div> -->
            <!-- <div class="libinput"> -->
                <input type="number" name="toan" class="form-control" value="<?php echo isset($_POST["toan"]) ? $_POST["toan"] : "" ; ?> "/>
            <!-- </div> -->
        </div>
